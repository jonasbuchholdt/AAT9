function [SNR, SNRa] = Sen2SNRoct(sentence_nr,sentence_gain)
...
A_weighting = makeOc([-50.5	-44.7	-39.4	-34.6	-30.2	-26.2	-22.5	-19.1	-16.1	-13.4	-10.9	-8.6	-6.6	-4.8	-3.2	-1.9	-0.8	0.0	0.6	1.0	1.2	1.3	1.2	1.0	0.5	-0.1	-1.1	-2.5	-4.3	-6.6]);
...
noise_lvl = makeOc(noise_measured+a_corrector+measurement_digifile_relator+noise_playback);


sentence_lvl = csvread('12_10_sentence_levels_komma.csv',sentence_nr,2,[sentence_nr,2,sentence_nr,31]);

sentence_lvl = makeOc(sentence_lvl+sentence_gain);
