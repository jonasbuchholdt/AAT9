function [f_axis,f_result,t_axis,t_result] = Lacoustics(cmd,gain,offset)
...
switch cmd
    ...
    case 'cali_mic'
     ...
     case 'test'
        ...
        [fs,impulse_response,irtime,tf,faxis]=IRmeas_fft_womics(ts,tw,flower,fupper,playgain,player,offset);
        t_axis = irtime;
    ...
    case 'transfer'
        [faxis, transfer_function, irtime, impulse_response] = Tranfer_function(gain,offset);
        f_axis = faxis;
