...
t = ([1:length(input(:,1))]-length(input(:,1)))/tauF;
...
% 
% % p_eF(1:31) = ((1/tauF)*trapz(output(:,1:31).^2.*exp(t)',1)).^(1/2);
% % p_eS(1:31) = ((1/tauS)*trapz(output(:,1:31).^2.*exp(t)',1)).^(1/2);
% % L_pF(1:31) = 20*log10((p_eF(1:31)/p0));
% % L_pS(1:31) = 20*log10((p_eS(1:31)/p0));
% 
% L_pF(1:31) = 20*log10((zeros(1,31)/p0));
% L_pS(1:31) = 20*log10((zeros(1,31)/p0));
