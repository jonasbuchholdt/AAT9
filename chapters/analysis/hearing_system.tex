...
\fig{anatomy-of-ear.jpg}{Breakdown of the different ear parts.}{fig:hearing_system}{1}
...
%\fig{more-on-the-vestibular-system-of-anatomy-of-cochlear-aqueduct.jpg}{Detail of middle and inner ear}{fig:hearing_system_detail ??}{0.6}
...
\fig{skull_vibration_pattern.pdf}{two-dimensional illustration of the vibration modes of the human skull at frequencies between \SI{100}{\hertz} and \SI{10}{\kilo\hertz}. The thick arrows indicate the stimulation position and the thin arrows indicate the response directions. The rigid body response at the lowest frequencies is illustrated in (a), while the response at frequencies between approximately \SI{400}{\hertz} – \SI{1}{\kilo\hertz} that is similar to a massspring system is shown in (b), where three sections of the skull move sequentially in opposite directions. In (c) the vibration responses for frequencies above \SI{2}{\kilo\hertz} is illustrated differently for the skull base and the cranial vault: at the skull base longitudinal wave propagation dominates the response while a mixture of vibration modes including bending waves is present at the cranial vault. Image source: \citep{puria_2013}}{fig:skull_vibration_pattern}{0.65}
...
\fig{ovidweb}{Transmission paths for \gls{ac} and \gls{bc}, image source:  \citep{stenfelt_2005}}{fig:hearing_system_pathway}{1}
